        ...
        <div class="modal-panel">
          ...
          <div class="objetos-grid">
            ...
            >
              ...
              <Transition name="submenu">
                <div v-if="objetoActivo === 'comodin'" class="submenu" @click.stop>
                  ...
                  <div class="submenu-fila">
                    <button class="submenu-btn submenu-btn--confirmar" @click="confirmarComodin('sumar')">
                      ▶ SUMAR
                    </button>
                    <button class="submenu-btn submenu-btn--confirmar" @click="confirmarComodin('restar')">
                      ▶ RESTAR
                    </button>
                  </div>
                </div>
            ...
            <div class="objeto-card objeto-card--bloqueado">
              <div class="objeto-img-wrap">
                <img src="@/assets/Images/jeringa.png" class="objeto-img objeto-img--bloqueado" alt="Jeringa" />
              </div>
            ...
            <div class="objeto-card objeto-card--bloqueado">
              <div class="objeto-img-wrap">
                <img src="@/assets/Images/encendedor.png" class="objeto-img objeto-img--bloqueado" alt="Encendedor" />
              </div>
            ...
            <div class="objeto-card objeto-card--bloqueado">
              <div class="objeto-img-wrap">
                <img src="@/assets/Images/puro.png" class="objeto-img objeto-img--bloqueado" alt="Puro" />
              </div>
...
const puedeUsarPistola = computed(() =>
  !bloqueado.value && store.objetos.pistola.balas > 0
)
const puedeUsarComodin = computed(() =>
  !bloqueado.value && store.objetos.comoDin.disponible > 0
)
