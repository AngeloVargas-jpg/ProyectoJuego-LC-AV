  ...
  <div class="ui">
    ...
    <div v-if="store.faseJuego === 'apuestas'" class="ui__panel ui__panel--bet">
      ...
      <div class="ui__bet-row">
        ...
        <button class="ui__btn ui__btn--bet" @click="placeBet" :disabled="!canBet">
          ▶ APOSTAR
        </button>
        <button class="ui__btn ui__btn--deny" @click="store.negarApuesta()">
          ✕ NEGAR
        </button>
      </div>
    ...
    <div v-else-if="store.faseJuego === 'turnoJugador'" class="ui__panel ui__panel--turn">
      <button class="ui__btn ui__btn--hit" @click="store.playerHit()" :disabled="store.gameOver">
        ▶ PEDIR CARTA
      </button>
      <button class="ui__btn ui__btn--stand" @click="store.playerStand()" :disabled="store.gameOver">
        ■ PLANTARSE
      </button>
    ...
    <div v-else-if="store.faseJuego === 'resultado' || store.gameOver" class="ui__panel ui__panel--result">
      ...
      <button class="ui__btn ui__btn--restart" @click="store.startGame()">
        ↺ NUEVA PARTIDA
      </button>
    </div>
...
function setPreset(n) { betAmount.value = n }
...
.ui__chip {
  ...
  border-radius: 50%;
  background:
    radial-gradient(circle at 35% 35%, #4a2a10, #2a1408);
